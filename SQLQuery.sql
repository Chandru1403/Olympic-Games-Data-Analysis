...
-- 10. FETCH THE TOP 5 ATHLETES WHO HAVE WON THE MOST MEDALS (GOLD/SILVER/BRON
...
-- 12 LIST DOWN TOTAL GOLD, SILVER AND BROZE MEDALS WON BY EACH COUNNTRY CORRESPONDING TO EACH OLYMPIC GAMES.
...
-- 19 WHO IS THE MOST SUCCESSFUL ATHLETE (IN TERMS OF TOTAL MEDALS WON) IN EACH SPORT, 
...
SELECT 
       NAME,
       SPORT, 
	   COUNT(MEDAL) AS TOTAL_MEDAL FROM ATHLETE
